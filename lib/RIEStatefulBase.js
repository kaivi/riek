...
var RIEStatefulBase = function (_RIEBase) {
    ...
    function RIEStatefulBase(props) {
        ...
        _this.renderDefaultEditingComponent = function () {
        ...
        _this.renderEditingComponent = function () {
            return _this.props.renderEditingComponent ? _this.props.renderEditingComponent.call(_this) : _this.renderDefaultEditingComponent();
        };

        _this.renderDefaultNormalComponent = function () {
        ...
        _this.renderNormalComponent = function () {
            return _this.props.renderNormalComponent ? _this.props.renderNormalComponent(_this) : _this.renderDefaultNormalComponent();
        };
