...
var RIESelect = function (_RIEStatefulBase) {
  ...
  function RIESelect() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RIESelect.__proto__ || Object.getPrototypeOf(RIESelect)).call.apply(_ref, [this].concat(args))), _this), _this.finishEditing = function () {
      ...
      var newValue = options.find(function (option) {
        return option.id === _reactDom2.default.findDOMNode(_this.refs.input).value;
      });

      _this.doValidations(newValue);

      if (!_this.state.invalid && value !== newValue) {
        _this.commit(newValue);
      }

      _this.cancelEditing();
    }, _this.getValue = function () {
      return _this.state.newValue ? _this.state.newValue.text : _this.props.value.text;
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(RIESelect, [{
