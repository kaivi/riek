...
class Demo extends React.Component {
  ...
  render = () => {
    const xhrDelaySwitch = this.state.simulateXHR ?
      <li>
        XHR delay:{" "}
        <RIENumber
          value={this.state.XHRDelay}
          change={this.changeState}
          validate={this.isValidXHRDelay}
          propName="XHRDelay"
          className="editable-pill"
          format={this.formatMillisecondsAppend}
        />
      </li>
     : null;
    return (
      <div>
        <div className="menu">
          <div className="fifty">
            ...
            <ul>
              <li>
                <i>boolean:</i> {this.state.boolean.toString()}
              </li>
              <li>
                <i>text:</i> {this.state.text}
              </li>
              <li>
                <i>textarea:</i> {this.state.textarea.replace(/\n/g, "\\n")}
              </li>
              <li>
                <i>number:</i> {this.state.number}
              </li>
              <li>
                <i>tags:</i> {[...this.state.tags].join(", ")}
              </li>
              <li>
                <i>select:</i> {JSON.stringify(this.state.select)}
              </li>
            </ul>
          </div>
          <div className="fifty">
            ...
            <ul>
              <li>
                Simulate XHR:{" "}
                <RIEToggle
                  value={this.state.simulateXHR}
                  change={this.changeState}
                  propName="simulateXHR"
                  textTrue="yes"
                  textFalse="don't"
                  className="editable-pill"
                />
              ...
              <li>
                <RIEToggle
                  value={this.state.showSource}
                  change={this.changeState}
                  propName="showSource"
                  textTrue="Source shown"
                  textFalse="Source hidden"
                  className="editable-pill"
                />
              </li>
              <li>
                <RIEToggle
                  ...
                  change={this.changeState}
                  propName="isDisabled"
                  textTrue="fields disabled"
                  textFalse="fields not disabled"
                  className="editable-pill"
                />
              </li>
              <li>
                <RIEToggle
                  value={this.state.editOnDoubleClick}
                  change={this.changeState}
                  propName="editOnDoubleClick"
                  textTrue="Edit on double click"
                  textFalse="Edit on click"
                  className="editable-pill"
                />
              </li>
            </ul>
